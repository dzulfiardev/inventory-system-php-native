...
if (isset($_GET['order_id'])) {
    ...
    $output = '';
    $statement = $connect->prepare("SELECT * FROM inventory_order WHERE inventory_order_id = :inventory_order_id LIMIT 1");
    $statement->execute([
    ...
    ';
        $statement = $connect->prepare("SELECT * FROM inventory_order_product WHERE inventory_order_id = :inventory_order_id");
        $statement->execute([
            ':inventory_order_id' => $_GET["order_id"]
        ]);
    ...
    ';
        ...
        $output .= '
                    ...
                    <br>
                    <br>    
                    <p align="center">  -------------------------------<br> Reciever Signature</p>
                    <br>
                    <br>
                    <br>
                </td>
